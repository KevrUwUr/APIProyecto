  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.botonesContainer}>
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShowCargos')}>
        ...
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShoeEmployees')}>
          <Text style={styles.botonesText}>Empleados</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShowBuyInvoice')}>
          <Text style={styles.botonesText}>Facturas de compra</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShowSellInvoice')}>
          <Text style={styles.botonesText}>Facturas de venta</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShowLosses')}>
          <Text style={styles.botonesText}>Perdidas</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShowProducts')}>
          <Text style={styles.botonesText}>Productos</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShowSuppliers')}>
          <Text style={styles.botonesText}>Proveedores</Text>
        </TouchableOpacity> 
        <TouchableOpacity style={styles.botones} onPress={() => navigation.navigate('ShowUsers')}>
