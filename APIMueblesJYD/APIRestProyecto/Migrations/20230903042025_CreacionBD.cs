        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPerdida = table.Column<int>(type: "int", nullable: false),
                    IdProducto = table.Column<int>(type: "int", nullable: false),
                    PerdidaProductoId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "IdPerdida", "IdProducto", "Cantidad", "Motivo", "PerdidaProductoId", "PrecioUnitario" },
                values: new object[,]
                {
                    { 1, 1, 5, "Robo", 1, 30000f },
                    { 2, 2, 5, "Roto", 2, 20000f },
                    { 3, 3, 5, "Mal Estado", 3, 35000f },
                    { 4, 4, 5, "Daño", 4, 50000f },
                    { 5, 5, 5, "Perdida", 5, 10000f }
                });
