    ...
    public class ContactoProveedorConfiguration : IEntityTypeConfiguration<ContactoProveedor>
    {
        public void Configure(EntityTypeBuilder<ContactoProveedor> builder)
        {
            ...
            (
                ...
                {
                    IdContactoProveedor = new int("c6d84c8a-5a75-4c97-b095-5429214a5acf"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("b048792f-384d-46bb-b2f1-2aeb775ebf75"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("d3d11e89-1d0c-4e92-9f6b-07d17b020cf7"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("f7a5b2a3-4a1e-4291-8f57-b6a740a4f56b"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("12f9d33b-5d79-42b9-b1f2-693d98ef5bf9"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("ec99599e-cf72-412a-b8c9-9d02fe5f1977"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("8cd4870a-5e20-4bc1-96fe-456c5c6962ed"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("61093b5b-1e9e-4dbf-b0b1-0b5989183e9a"),
                ...
                new ContactoProveedor
                {
                    IdContactoProveedor = new int("92d541d9-8570-4c72-b92c-6f3e7d918c48"),
