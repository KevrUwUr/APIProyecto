    ...
    public class PerdidaConfiguration : IEntityTypeConfiguration<Perdida>
    {
        public void Configure(EntityTypeBuilder<Perdida> builder)
        {
            builder.HasData
                ...
                new Perdida
                {
                    IdPerdida = new int("359a5169-0142-4c4d-b102-b12b3f17b7ac"),
                ...
                new Perdida
                {
                    ...
                    IdEmpleado = new int("8b30ee54-33d5-4a59-9c48-c918c213e352"),
                    FechaPerdida = new DateTime(2023, 06, 21),
                    Estado = 2,
                    Total = 200000
                },
                ...
                new Perdida
                {
                    IdPerdida = new int("0081fd32-45d7-11ee-be56-0242ac120005"),
