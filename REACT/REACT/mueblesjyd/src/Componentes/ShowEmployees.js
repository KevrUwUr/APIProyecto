...
const ShowJobs = () => {
  ...
  const [empleadoId, setId] = useState();
  const [empleados, setCargos] = useState([]);
  ...
  const URL = `https://localhost:7284/api/empleados/${empleadoId}`;
  ...
  const validar = (empleadoId) => {
    ...
    if (nombres.trim() === "") {
      ...
      if (operation === 1) {
        parametros = { nombres: nombres, apellidos: apellidos, sexo: sexo, fechaNacimiento: fechaNacimiento, estado: estado };
        metodo = "POST";
      } else {
        parametros = { nombres: nombres, apellidos: apellidos, sexo: sexo, fechaNacimiento: fechaNacimiento, estado: estado };
  ...
  const deleteCargo = (empleadoId, name) => {
            ...
            <div className="card-header py-3 custom-card-header">
              <div className="row table-topper align-items-center">
                <div className="col-12 col-sm-5 col-md-6 text-start custom-title">
                  <h1 className="custom-title">Empleados</h1>
                </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="d-grid col-6 mx-auto">
                <button
                  onClick={() => validar(idToEdit, nombres)}
